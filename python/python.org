...
#+BEGIN_SRC python :var slippyparms=slippyparms
  ...
  the same tile
      ...
      (nwx, nwy) = tilexy2nwmerclatlon(0, 0, zoom)
      (sex, sey) = tilexy2nwmerclatlon(1, 1, zoom)
...
#+BEGIN_SRC python :results output verbatim
  ...
  coordinates of the required tile.
          ...
          lat_rad, lon_rad =  merclatlon2tilexy(*wgs2merc(lat_deg, lon_deg), zoom=zoom)
