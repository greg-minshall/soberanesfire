...
#+name: deg2url
#+BEGIN_SRC python :var lat=36.4 :var lon=-121.858 :var zoom=10 :var mapurl="https://maps.wikimedia.org/osm-intl" :results output
  ...
  print "{m}/{z}/{x}/{y}.png".format(m=mapurl, z=zoom, x=x, y=y)
#+END_SRC

#+RESULTS:
: https://maps.wikimedia.org/osm-intl/10/165/400.png

#+CALL: deg2url(zoom=11)

#+RESULTS:
: https://maps.wikimedia.org/osm-intl/11/330/801.png
...
seems nice.  a bit long in the tooth, though (copyright says 2006-2010).


*** converting from 36 deg 45'32.99 to lat/lon
