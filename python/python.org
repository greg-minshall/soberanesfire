...
eprint: print to stderr.  must be *first* line in file
...
without worrying much about GIS APIs.  unfortunately, when a new plane
was put into service, the new file formats didn't work for this.
...
not for the military-produced files.
...
**** [[https://pypi.python.org/pypi/lxml/3.6.1][lxml]]
...
#+BEGIN_SRC python :results output verbatim
  ...
  input= ["/Users/minshall/work/gis/play/IR/20160729_Soberanes_IR/doc.kml",
          "/Users/minshall/work/gis/play/IR/20160812_c0730_Soberanes_Aircraft3_All/doc.kml"]
  # good simple reference for xpath expressions:
  # http://www.w3schools.com/xsl/xpath_syntax.asp
  search = """//kml2.2:MultiGeometry[../kml2.2:name="Heat Perimeter"] |
           //kml2.2:MultiGeometry[../../kml2.2:name="Fire Perimeter"]"""

  which = 1

  tree = etree.parse(input[which])

  # absolute location
  tree.xpath('/kml2.2:kml/kml2.2:Document', namespaces=ns)

  # searching!
  tree.xpath('//kml2.2:Placemark', namespaces=ns)

  # more searching
  tree.xpath('//kml2.2:Placemark[kml2.2:name="Heat Perimeter"]', namespaces=ns)
  tree.xpath('//kml2.2:Placemark[kml2.2:name="Heat Perimeter"]/kml2.2:MultiGeometry', namespaces=ns)

  print type(tree.xpath(search, namespaces=ns)[0])
