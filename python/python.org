...
this is
a test
of this which is sitting here
#+END_EXAMPLE

#+BEGIN_SRC python :var x=test :results output verbatim
print x;
#+END_SRC
...
#+BEGIN_SRC python :var colorbrewer=colorbrewer :var stylefrag=stylefrag :results output verbatim :cache yes
  ...
  for color in colorbrewer[0]:
      print re.sub("<REPLACEME>", color, stylefrag)
#+END_SRC

#+RESULTS[979dc199c141b60285c7c60998814f3c89470392]: pprolog2
