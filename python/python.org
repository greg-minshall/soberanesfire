...
#+BEGIN_SRC python
  ...
  def tilexyfixup(xtile, ytile, zoom):
    ...
    print "tilexyfixup: ", xtile, ytile, zoom
    # deal with wrapping
    if xtile < 0:
      # if *x* is negative, reflect around x axis
      xtile %= n
...
#+BEGIN_SRC python :results output verbatim
  ...
  def bbox(lat, lon, zoom):
     ...
     print "deg2tilexy: ", lat, lon, zoom, " ==> ", tcenterx, tcentery
...
tilexyfixup:  5 12 5
5 12
deg2tilexy:  36.4 -121.858 5  ==>  5 12
wit, hit:  5 5
...
#+call: getpngs(zoom=0, lat=90, lon=0)
...
tx, ty, xoff, yoff:  6 2 0 0
tx, ty, xoff, yoff:  6 3 0 1
tx, ty, xoff, yoff:  6 4 0 2
tx, ty, xoff, yoff:  6 5 0 3
tx, ty, xoff, yoff:  6 6 0 4
tx, ty, xoff, yoff:  7 2 1 0
tx, ty, xoff, yoff:  7 3 1 1
tx, ty, xoff, yoff:  7 4 1 2
tx, ty, xoff, yoff:  7 5 1 3
tx, ty, xoff, yoff:  7 6 1 4
tx, ty, xoff, yoff:  0 2 2 0
tx, ty, xoff, yoff:  0 3 2 1
tx, ty, xoff, yoff:  0 4 2 2
tx, ty, xoff, yoff:  0 5 2 3
tx, ty, xoff, yoff:  0 6 2 4
tx, ty, xoff, yoff:  1 2 3 0
tx, ty, xoff, yoff:  1 3 3 1
tx, ty, xoff, yoff:  1 4 3 2
tx, ty, xoff, yoff:  1 5 3 3
tx, ty, xoff, yoff:  1 6 3 4
tx, ty, xoff, yoff:  2 2 4 0
tx, ty, xoff, yoff:  2 3 4 1
tx, ty, xoff, yoff:  2 4 4 2
tx, ty, xoff, yoff:  2 5 4 3
tx, ty, xoff, yoff:  2 6 4 4
#+end_example
