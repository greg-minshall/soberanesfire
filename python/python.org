...
#+BEGIN_SRC python
  ...
  def bbox(lat, lon, zoom):
     ...
     tcenterx,tcentery = deg2xy(lat, lon, zoom)
     ...
     swit = int(math.ceil((p['screenx']*1.0)/(p['tilex']*1.0)))
     shit = int(math.ceil((p['screeny']*1.0)/(p['tiley']*1.0)))
     swit = min(swit, 3)
     shit = min(swit, 3)                 # enforce some minimum
     if swit % 2 == 0:
        swit += 1
     if shit % 2 == 0:                 # enforce oddness, so we *have* a
        shit += 1                      # center XXX

     tnw = (tcenterx - ((swit+1)/2), tcentery - ((shit+1)/2))
     tse = (tcenterx + ((swit+1)/2), tcentery + ((shit+1)/2))

     # check to see if we are zoomed too far out
     if tnw[0] < 0 or tnw[1] < 0:
        return tilenos(lat, lon, zoom+1)
     else:
        return (tnw[0], tnw[1], tse[0], tse[1], zoom)
#+END_SRC
...
#+BEGIN_SRC python :results output verbatim :var lat=36.4 :var lon=-121.858 :var zoom=5 :var parms=parameters :var mapurl=MAPURL
  ...
  (tnwx, tnwy, tsex, tsey, zoom) = bbox(lat, lon, zoom)
  ...
  for tx in range(tnwx, tsex+1):
     ...
     for ty in range(tnwy, tsey+1):
        ...
        im.paste(im2, box=(imx, imy))
        print im.getbbox(), len(im.getdata())
        imy += p['tiley']
     imx += p['tilex']
  #im.show()
...
#+begin_example
1280 1280 None
http://localhost:8080/tiles/osm/webmercator/5/3/10.png
(0, 0, 256, 256) 1638400
http://localhost:8080/tiles/osm/webmercator/5/3/11.png
(0, 0, 256, 512) 1638400
http://localhost:8080/tiles/osm/webmercator/5/3/12.png
(0, 0, 256, 768) 1638400
http://localhost:8080/tiles/osm/webmercator/5/3/13.png
(0, 0, 256, 1024) 1638400
http://localhost:8080/tiles/osm/webmercator/5/3/14.png
(0, 0, 256, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/4/10.png
(0, 0, 512, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/4/11.png
(0, 0, 512, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/4/12.png
(0, 0, 512, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/4/13.png
(0, 0, 512, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/4/14.png
(0, 0, 512, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/5/10.png
(0, 0, 768, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/5/11.png
(0, 0, 768, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/5/12.png
(0, 0, 768, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/5/13.png
(0, 0, 768, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/5/14.png
(0, 0, 768, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/6/10.png
(0, 0, 1024, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/6/11.png
(0, 0, 1024, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/6/12.png
(0, 0, 1024, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/6/13.png
(0, 0, 1024, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/6/14.png
(0, 0, 1024, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/7/10.png
(0, 0, 1280, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/7/11.png
(0, 0, 1280, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/7/12.png
(0, 0, 1280, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/7/13.png
(0, 0, 1280, 1280) 1638400
http://localhost:8080/tiles/osm/webmercator/5/7/14.png
(0, 0, 1280, 1280) 1638400
#+end_example
...
openstreetmap has a [[http://ojw.dev.openstreetmap.org/StaticMap/?api=json][page]] that describes their [[http://ojw.dev.openstreetmap.org/StaticMap/?mode=API][map tile protocol]] in JSON.
