...
#+BEGIN_SRC python :var slippyparms=slippyparms
  ...
  this location
      ...
      x = (1.0 + (mlon/math.pi))/2.0
      y = (1.0 - (mlat/math.pi))/2.0
  ...
  (lat, lon) of its *northwest* corner"""
      ...
      n = 2**zoom
      mlon = ((((tilex*1.0)/n)*2.0)-1.0)*math.pi
      mlat = (1-(((tiley*1.0)/n)*2.0))*math.pi
...
#+BEGIN_SRC python :results output verbatim
  ...
  class TileBbox:                    # a Tile Bounding Box
      ...
      @staticmethod 
      def tilexy2latlon(tilex, tiley, zoom):
    ...
    (TILEX, TILEY)"""
          ...
          import math
          lon_deg = (((tilex*1.0)/(2.0**zoom))*360.0)-180.0
          lat_rad = math.atan(math.sinh(math.pi-((tiley*2*math.pi)/(2.0**zoom))))
    ...
    of this box
          ...
          """
          return TileBbox.tilexy2latlon(self.tpt.x, self.tpt.y, self.zoom)
    ...
    this box
          ...
          return TileBbox.tilexy2latlon(se.x, se.y, self.zoom) # XXX
...
#+RESULTS:
#+begin_example
wlat, wlon, mlat, mlon:  55.777 -146.25 67.500759188 -146.25
wlat, wlon, mlat, mlon:  55.777 -146.25 67.500759188 -146.25
wlat, wlon, mlat, mlon:  55.777 -146.25 67.500759188 -146.25
wlat, wlon, mlat, mlon:  55.777 -146.25 67.500759188 -146.25
perytile, perxtile:  21.262775 45.0
nwlat, nwlon, zoom, hwit:  (55.777, -146.25, 3, 5)
diff by tbbox:  (0.0, 135.0, -66.51326044311186, -180.0) (66.51326044311186, 315.0)
diff by algorithm:  (55.777, -146.25, -50.53687500000001, 78.75) (106.31387500000001, -225.0)

wlat, wlon, mlat, mlon:  0.0 135.0 0.0 135.0
2nd diff by tbbox:  (0.0, 135.0, -66.51326044311186, -180.0) (145.6845950839313, 135.0)
#+end_example


: perytile, perxtile:  21.262775 45.0
: nwlat, nwlon, zoom, hwit:  (55.777, -146.25, 3, 5)
: diff by tbbox:  (85.0511287798066, 90.0, -40.97989806962013, -45.0) (126.03102684942672, 135.0)
: diff by algorithm:  (55.777, -146.25, -50.53687500000001, 78.75) (106.31387500000001, -225.0)
: 
: 2nd diff by tbbox:  (85.0511287798066, 90.0, -40.97989806962013, -45.0) (145.6845950839313, -225.0)
...
#+RESULTS:
: (0.0, 0)
: (mlat, mlon), (back2mlat, back2mlon), (diff):  (37.404780729700335, -163) (37.502762302228156, -163.16646844581987) (-0.09798157252782147, 0.16646844581987352)
