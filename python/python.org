...
#+BEGIN_SRC python
  ...
  def tilexyfixup(xtile, ytile, zoom):
    ...
    if ytile < 0 or ytile > n:
      # if *y* out of bounds, negative, reflect around y axis
      if ytile < 0:
        ytile = n - (ytile%n)     # reflect around the N pole
      else:
        ytile %= n                # reflect around the S pole
      # now, do we need to go to the other side of the world?
...
#+BEGIN_SRC python :results output verbatim :var lat=36.4 :var lon=-121.858 :var zoom=5 :var parms=parameters :var mapurl=MAPURL
  ...
  # im.show()
  im.save("/Users/minshall/work/gis/python/foo.png")
#+END_SRC

#+RESULTS: getpngs
#+begin_example
tilexyfixup: called with: xtile, ytile, zoom:  5 12 5
tilexyfixup returning (xtile, ytile):  5 12
deg2tilexy(lat, lon, zoom) 36.4 -121.858 5  ==> tcenterx, tcentery 5 12
wit, hit:  5 5
(before tilexyfixup) tnwx, tnwy:  3 10
tilexyfixup: called with: xtile, ytile, zoom:  3 10 5
tilexyfixup returning (xtile, ytile):  3 10
(after tilexyfixup) tnwx, tnwy:  3 10
bbox tnwx, tnwy, wit, hit, zoom:  3 10 5 5 5
iter tx, ty, xoff, yoff:  3 10 0 0
iter tx, ty, xoff, yoff:  3 11 0 1
iter tx, ty, xoff, yoff:  3 12 0 2
iter tx, ty, xoff, yoff:  3 13 0 3
iter tx, ty, xoff, yoff:  3 14 0 4
iter tx, ty, xoff, yoff:  4 10 1 0
iter tx, ty, xoff, yoff:  4 11 1 1
iter tx, ty, xoff, yoff:  4 12 1 2
iter tx, ty, xoff, yoff:  4 13 1 3
iter tx, ty, xoff, yoff:  4 14 1 4
iter tx, ty, xoff, yoff:  5 10 2 0
iter tx, ty, xoff, yoff:  5 11 2 1
iter tx, ty, xoff, yoff:  5 12 2 2
iter tx, ty, xoff, yoff:  5 13 2 3
iter tx, ty, xoff, yoff:  5 14 2 4
iter tx, ty, xoff, yoff:  6 10 3 0
iter tx, ty, xoff, yoff:  6 11 3 1
iter tx, ty, xoff, yoff:  6 12 3 2
iter tx, ty, xoff, yoff:  6 13 3 3
iter tx, ty, xoff, yoff:  6 14 3 4
iter tx, ty, xoff, yoff:  7 10 4 0
iter tx, ty, xoff, yoff:  7 11 4 1
iter tx, ty, xoff, yoff:  7 12 4 2
iter tx, ty, xoff, yoff:  7 13 4 3
iter tx, ty, xoff, yoff:  7 14 4 4
#+end_example

#+call: getpngs(zoom=0, lat=85, lon=0)

#+RESULTS:
#+begin_example
tilexyfixup: called with: xtile, ytile, zoom:  0 0 0
tilexyfixup returning (xtile, ytile):  0 0
deg2tilexy(lat, lon, zoom) 85 0 0  ==> tcenterx, tcentery 0 0
tilexyfixup: called with: xtile, ytile, zoom:  1 0 1
tilexyfixup returning (xtile, ytile):  1 0
deg2tilexy(lat, lon, zoom) 85 0 1  ==> tcenterx, tcentery 1 0
tilexyfixup: called with: xtile, ytile, zoom:  2 0 2
tilexyfixup returning (xtile, ytile):  2 0
deg2tilexy(lat, lon, zoom) 85 0 2  ==> tcenterx, tcentery 2 0
tilexyfixup: called with: xtile, ytile, zoom:  4 0 3
tilexyfixup returning (xtile, ytile):  4 0
deg2tilexy(lat, lon, zoom) 85 0 3  ==> tcenterx, tcentery 4 0
wit, hit:  5 5
(before tilexyfixup) tnwx, tnwy:  2 -2
tilexyfixup: called with: xtile, ytile, zoom:  2 -2 3
tilexyfixup returning (xtile, ytile):  2 2
(after tilexyfixup) tnwx, tnwy:  2 2
bbox tnwx, tnwy, wit, hit, zoom:  2 2 5 5 3
iter tx, ty, xoff, yoff:  2 2 0 0
iter tx, ty, xoff, yoff:  2 3 0 1
iter tx, ty, xoff, yoff:  2 4 0 2
iter tx, ty, xoff, yoff:  2 5 0 3
iter tx, ty, xoff, yoff:  2 6 0 4
iter tx, ty, xoff, yoff:  3 2 1 0
iter tx, ty, xoff, yoff:  3 3 1 1
iter tx, ty, xoff, yoff:  3 4 1 2
iter tx, ty, xoff, yoff:  3 5 1 3
iter tx, ty, xoff, yoff:  3 6 1 4
iter tx, ty, xoff, yoff:  4 2 2 0
iter tx, ty, xoff, yoff:  4 3 2 1
iter tx, ty, xoff, yoff:  4 4 2 2
iter tx, ty, xoff, yoff:  4 5 2 3
iter tx, ty, xoff, yoff:  4 6 2 4
iter tx, ty, xoff, yoff:  5 2 3 0
iter tx, ty, xoff, yoff:  5 3 3 1
iter tx, ty, xoff, yoff:  5 4 3 2
iter tx, ty, xoff, yoff:  5 5 3 3
iter tx, ty, xoff, yoff:  5 6 3 4
iter tx, ty, xoff, yoff:  6 2 4 0
iter tx, ty, xoff, yoff:  6 3 4 1
iter tx, ty, xoff, yoff:  6 4 4 2
iter tx, ty, xoff, yoff:  6 5 4 3
iter tx, ty, xoff, yoff:  6 6 4 4
#+end_example
