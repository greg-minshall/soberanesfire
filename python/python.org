...
#+BEGIN_SRC python :var kmlfiles=filelist :var trigger="Heat Perimeter" :var select="Polygon" :results output verbatim :tangle program.py
  ...
  colorbrewer= [0xfff7fb, 0xece7f2, 0xd0d1e6, 0xa6bddb, 0x74a9cf,
  ...
  def fprolog2():
      return fragsub(0, colorsub('0xffffff', stylefrag))
  ...
  def fprolog3():
      ...
      for i in range(len(colorbrewer)):
          result = "{0}{1}".format(result,
                                   fragsub(i+1,
                                           colorsub(colorbrewer[i], stylefrag)))
      return result

  def fprolog4():
      return fragsub("N", colorsub(0x0000dc, stylefrag))
  ...
  def kmlfrags():
      ...
      return "{0}{1}".format(pprolog1, ppost)
