...
#+BEGIN_SRC python :results output verbatim
  ...
  def bbox(lat, lon, zoom):
     ...
     wit = min(wit, 3)
     hit = min(wit, 3)                 # enforce some minimum
     if wit % 2 == 0:
        wit += 1
...
3 1
3 1
bbox tnwx, tnwy, wit, hit, zoom:  3 1 3 3 2
tx, ty, xoff, yoff:  3 1 0 0
tx, ty, xoff, yoff:  3 2 0 1
tx, ty, xoff, yoff:  3 3 0 2
tx, ty, xoff, yoff:  0 1 1 0
tx, ty, xoff, yoff:  0 2 1 1
tx, ty, xoff, yoff:  0 3 1 2
tx, ty, xoff, yoff:  1 1 2 0
tx, ty, xoff, yoff:  1 2 2 1
tx, ty, xoff, yoff:  1 3 2 2
#+end_example
