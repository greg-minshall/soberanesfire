...
#+BEGIN_SRC python :results output verbatim :var zoom=0 :var hwit=1 :var nwlon=-146.25 :var nwlat=55.7765730187 :var parms=parameters
  <<tilebbox>>
  def calcbyalgorith(nwlat, nwlon, zoom):
      ...
      return (nwlat-selat, nwlon-selon)
  ...
  print "diff by tbbox: ", bytbbox
  print "diff by algorithm: ", byalgo
#+END_SRC

#+RESULTS:
: perytile, perxtile:  170.1022 360.0
: nwlat, nwlon, hwit:  (55.7765730187, -146.25, 5)
: diff by tbbox:  (151.56438922291846, -270.0)
: diff by algorithm:  (850.5110000000001, -1800.0)
